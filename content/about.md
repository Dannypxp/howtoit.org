...
**[CVE Severity Prediction](Presentation)** — Pulled 1,996 CVEs from the NIST NVD API across Windows 7, XP, and 11 and built a severity prediction pipeline comparing Random Forest, XGBoost, and Linear Regression. Landed at R² = 0.83 on CVSS score prediction.

**[PawPal Ultra](https://github.com/Dannypxp/applied-ai-system-project)** — A RAG pipeline built on the Gemini API with semantic indexing over internal markdown knowledge bases. Designed a multi-mode response router with three answer strategies so users have explicit control over whether the answer comes from internal docs, Gemini, or a synthesis of both.
